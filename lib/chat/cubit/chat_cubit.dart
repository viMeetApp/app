...
class ChatCubit extends Cubit<Stream<List<Message>>> {
  ...
  StreamController<List<Message>> _messageStreamController = new StreamController<List<Message>>();
  ...
  void requestPosts(){
    ...
    pagePostQuery.snapshots().listen((postsSnapshot) { 
      if(postsSnapshot.docs.isNotEmpty){
        ...
        List<Message> allPosts = _allPagedResults.fold<List<Message>>(List<Message>(), (initialValue, pageItems) => initialValue..addAll(pageItems));
