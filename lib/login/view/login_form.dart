    ...
    return BlocListener<LoginCubit, LoginState>(
      ...
      child: BlocBuilder<LoginCubit,LoginState>(
        ...
        builder: (context,state){
          return Column(children: [TextField(controller: _nameController,decoration: InputDecoration(labelText: 'username', errorText: !state.isNameValid?'Bitte gibt einen Benutzername ein':null),), RaisedButton(onPressed: (){BlocProvider.of<LoginCubit>(context).submitted(_nameController.text);}, child: Text("Log In"))],);
